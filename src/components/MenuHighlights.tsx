...
const categories = [
  {
    title: "Cocktails",
    items: [
      { name: "Pina Colada", price: "15,00" },
      { name: "Margarita", price: "15,00" },
      { name: "Tequila Sunrise", price: "15,00" },
      { name: "Sex on the Beach", price: "15,00" },
      { name: "Moscow Mule", price: "15,00" },
      { name: "Whisky", price: "15,00" },
    ],
  },
  {
    title: "Bouteilles",
    items: [
      { name: "Grey Goose 75CL", price: "250,00" },
      { name: "Jack Daniel's 75CL", price: "250,00" },
      { name: "Jack Daniel's - Honey 75CL", price: "250,00" },
      { name: "Ruinart Blanc de Blancs 75CL", price: "220,00" },
      { name: "Veuve Clicquot 75CL", price: "160,00" },
      { name: "Moët & Chandon Brut 75CL", price: "140,00" },
      { name: "Rosé Minuty 75CL", price: "70,00" },
      { name: "Blanc Chardonnay 75CL", price: "70,00" },
    ],
  },
  {
